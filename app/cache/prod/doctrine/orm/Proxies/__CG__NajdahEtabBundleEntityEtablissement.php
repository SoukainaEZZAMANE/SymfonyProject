...
namespace Proxies\__CG__\Najdah\EtabBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Etablissement extends \Najdah\EtabBundle\Entity\Etablissement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'designation', 'x', 'y', 'adresse', 'image', 'type', 'file', 'ville');
        }

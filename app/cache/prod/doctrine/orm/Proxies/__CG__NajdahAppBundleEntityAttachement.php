 ...
 */
class Attachement extends \Najdah\AppBundle\Entity\Attachement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'lien', 'titre', 'description', 'declaration');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Attachement $proxy) {
    ...
    public function setDeclaration(\Najdah\AppBundle\Entity\Declaration $declaration = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeclaration', array($declaration));
    ...
    public function getDeclaration()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeclaration', array());

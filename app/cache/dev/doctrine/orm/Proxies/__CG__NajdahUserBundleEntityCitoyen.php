 ...
 */
class Citoyen extends \Najdah\UserBundle\Entity\Citoyen implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'prenom', 'cin', 'tel', 'ville', 'nationalite');
        }

 ...
 */
class TypeDeclaration extends \Najdah\AppBundle\Entity\TypeDeclaration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeDeclaration $proxy) {

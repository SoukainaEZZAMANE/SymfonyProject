 ...
 */
class EtatDeclaration extends \Najdah\AppBundle\Entity\EtatDeclaration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EtatDeclaration $proxy) {
